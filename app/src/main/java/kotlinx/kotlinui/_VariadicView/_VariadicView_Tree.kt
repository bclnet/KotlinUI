...
fun <Root : _VariadicView_Root, Content : View> _VariadicView_Tree<Root, Content>._makeView(
    view: _GraphValue<_VariadicView_Tree<Root, Content>>,
    inputs: _ViewInputs
): _ViewOutputs = exitProcess(0)

fun <Root : _VariadicView_Root, Content : View> _VariadicView_Tree<Root, Content>._makeViewList(
    view: _GraphValue<_VariadicView_Tree<Root, Content>>,
