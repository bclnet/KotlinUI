...
class MyToolWindow(toolWindow: ToolWindow) {
    ...
    fun currentDateTime() {
        ...
        currentDate!!.icon = ImageIcon(javaClass.getResource("/windows/Calendar-icon.png"))
        ...
        currentTime!!.icon = ImageIcon(javaClass.getResource("/windows/Time-icon.png"))
        // Get time zone
        ...
        timeZone!!.icon = ImageIcon(javaClass.getResource("/windows/Time-zone-icon.png"))
    }
