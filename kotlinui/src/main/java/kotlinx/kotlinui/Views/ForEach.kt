...
internal fun <Data : List<Any?>, ID, Content : View> ForEach<Data, ID, Content>._makeView(
    view: _GraphValue<ForEach<Data, ID, Content>>,
    inputs: _ViewInputs
): _ViewOutputs = exitProcess(0)

internal fun <Data : List<Any?>, ID, Content : View> ForEach<Data, ID, Content>._makeViewList(
    view: _GraphValue<ForEach<Data, ID, Content>>,
